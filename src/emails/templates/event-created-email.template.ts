export const eventCreatedEmailTemplate = (
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Event Successfully Created - Compass Events</title>
            ...
            <tr>
              <td align="center" style="padding: 24px;">
                ...
                <p style="font-size:15px; color:#444444; line-height:1.5; margin:0 0 16px 0;">
                  ...
                  Your event <strong>${eventName}</strong> has been successfully created on <strong>Compass Events</strong>.<br /><br />
                  <strong>Date & Time:</strong> ${formattedDate}<br />
                  <strong>Description:</strong> ${eventDescription}<br /><br />
                  Thank you for using our platform to organize your event.<br />
